...
flags.DEFINE_string('hf_dataset_name', None, 'HuggingFace dataset name (e.g., "benjamin-paine/imagenet-1k-256x256"). If provided, loads from HF Hub instead of local path')
...
def main(argv):
    ...
    # Validate paths
    print("HF", FLAGS.hf_dataset_name)
